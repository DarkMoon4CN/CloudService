(function (a) {
    ...
    a.maskElement = function (d, c) {
        ...
        if (c !== undefined) {
            ...
            b.css("left", Math.round(d.width() / 2 - (b.width() - parseInt(b.css("padding-left")) - parseInt(b.css("padding-right"))) / 2) + "px"); b.show()
        }
    };
...
(function ($) {
    $.mask=function(c){
        if($("body:first").css("position") == "static"){
           $("body:first").addClass("masked-relative");
        }
        $("body:first").addClass("masked-relative");
